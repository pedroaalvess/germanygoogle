#!/usr/bin/env python3
"""
Script zum Füllen der Datenbank mit Google-Stellenangeboten auf Deutsch
"""
...
def create_sample_jobs():
    """Beispiel-Stellenangebote erstellen"""
    
    jobs_data = [
        {
            'title': 'Senior Software-Ingenieur',
            'description': '''Werden Sie Teil unseres Engineering-Teams und entwickeln Sie innovative Produkte, die von Milliarden von Nutzern weltweit verwendet werden. Sie arbeiten an spannenden Projekten mit neuesten Technologien und tragen dazu bei, die Zukunft der Technologie zu gestalten.

Verantwortlichkeiten:
• Design und Entwicklung von Web- und Mobile-Anwendungen im großen Maßstab
• Zusammenarbeit mit multidisziplinären Teams zur Lieferung hochwertiger Produkte
• Optimierung der Performance und Skalierbarkeit bestehender Systeme
• Mentoring von Junior-Entwicklern und Beitrag zur technischen Kultur

Arbeitsumgebung:
Sie arbeiten in einer stimulierenden Umgebung mit Zugang zu neuesten Technologien, kontinuierlicher Weiterbildung und beruflichen Wachstumsmöglichkeiten.''',
            'requirements': '''Erforderliche Qualifikationen:
• Master in Informatik oder gleichwertig
• 5+ Jahre Erfahrung in der Softwareentwicklung
• Expertise in Python, Java oder C++
• Erfahrung mit verteilten Architekturen
• Beherrschung relationaler und NoSQL-Datenbanken

Gewünschte Qualifikationen:
• Erfahrung mit Google Cloud Platform
• Kenntnisse in Agile/Scrum-Methoden
• Open-Source-Beiträge
• Erfahrung im Machine Learning''',
            'salary_min': 2800,
            'salary_max': 3500,
            ...
            'benefits': '''Vorteile:
• Wettbewerbsfähiges Gehalt mit Jahresbonus
• Premium-Krankenversicherung
• 30 Tage bezahlter Urlaub
• Hybrid-Homeoffice (3 Tage/Woche)
